// Mock data for Tu Crédito backoffice
import type { Cliente, Credito, Banco } from './types';
...
// Creditos by status for charts
export const getCreditosByEstado = () => {
  const estados: Record<string, number> = {};
  mockCreditos.forEach(c => {
